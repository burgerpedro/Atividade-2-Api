...
public class AlunoService {
	...
	public List<Aluno> getAllAlunos(){
		...
		for(Aluno aluno: alunos) {
			...
			alunoDTO.setEmprestimosDTO(listaEmprestimoDTO);
	...
	public AlunoDTO getAlunoByIdDTO() {
		Aluno aluno = alunoRepository.findById(null).orElse(null);
		AlunoDTO alunoDTO = toDTO(aluno);
	...
	public AlunoDTO updateAlunoDTO(AlunoDTO alunoDTO,Integer id) {
		...
		if(alunoExisteNoBanco != null) {
			alunoDTO.setNumeroMatriculaAluno(alunoExisteNoBanco.getNumeroMatriculaAluno());
			alunoExisteNoBanco = toEntidade(alunoDTO);
			
			Aluno AlunoAtualizado = alunoRepository.save(alunoExisteNoBanco);
			
			alunoAtualizadaDTO = toDTO(AlunoAtualizado);
		}
		return alunoAtualizadaDTO;
	}
